...
class DisplayQuestions : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        questionsList.add(QuestionModel("Which package contains the Random class?","(a)  java.lang package","(b)  java.awt package","(c)  java.io package","(d)  java.util package","(d)  java.util package"))
        questionsList.add(QuestionModel("Who invented Java Programming?","(a)  Guido van Rossum","(b)  James Gosling","(c)  Dennis Ritchie","(d)  Bjarne Stroustrup","(b)  James Gosling"))
        questionsList.add(QuestionModel("Which one of the following is not a Java feature?","(a)  Object-oriented","(b)  Portable","(c)  Use of pointers","(d)  Dynamic and Extensible","(c)  Use of pointers"))
        questionsList.add(QuestionModel("Which of the following is not an OOPS concept in Java?","(a)  Polymorphism","(b)  Inheritance","(c)  Compilation","(d)  Encapsulation","(c)  Compilation"))
        questionsList.add(QuestionModel(" Which of these are selection statements in Java?","(a)  if()","(b)  break","(c)  continue","(d)  for()","(a)  if()"))
