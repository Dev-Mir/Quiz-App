...
class PythonQuestions : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        questionsList.add(QuestionModel("Which one of the following is the correct extension of the Python file?","(a)  .py","(b)  .python","(c)  .p","(d)  None of these","(a)  .py"))
        questionsList.add(QuestionModel("Which character is used in Python to make a single line comment?","(a)  //","(b)  #","(c)  /","(d)  !","(b)  #"))
        questionsList.add(QuestionModel("Which of the following is not a keyword in Python language?","(a)  val","(b)  raise","(c)  try","(d)  with","(a)  val"))
        questionsList.add(QuestionModel("Which of the following operators is the correct option for power(ab)?","(a)  a ^ b","(b)  a**b","(c)  a ^ ^ b","(d)  a ^ * b","(b)  a**b"))
        questionsList.add(QuestionModel("What will be the output of this function? round(4.576)  ","(a)  4","(b)  5","(c)  576","(d)  5","(d)  5"))
